 ...
 * ProjectTemplate
 *
 * Created by artembirmin on 1/6/2023.
 */
 ...
 * see it on [GitHub](https://github.com/anastr/MySpeedView)
 */
open class MySpeedView @JvmOverloads constructor(
    context: Context,
    ...
    private fun initAttributeSet(context: Context, attrs: AttributeSet?) {
        ...
        circlePaint.color =
                a.getColor(R.styleable.FreerideSpeedometerView_sv_centerCircleColor,
                    circlePaint.color)
        centerCircleRadius =
                a.getDimension(R.styleable.FreerideSpeedometerView_bgCircleColor,
                    centerCircleRadius)
